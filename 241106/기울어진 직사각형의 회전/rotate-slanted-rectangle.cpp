...
void tiltedRectangleRotation(int n, int m, vector<vector<int>>& matrix, int r, int c, int m1, int m2, int m3, int m4, int dir) {
    ...
    if (dir == 0) {
        ...
        for (int bottomRight = rightX; bottomRight > bottomX + 1; bottomRight--) {
            int ny = dy[0] + rightY;
            int nx = dx[0] + rightX;
        ...
        for (int bottomLeft = leftX; bottomLeft + 1 < bottomX; bottomLeft++) {
            int ny = dy1[0] + leftY;
            int nx = dx1[0] + leftX;
...
int main() {
    ...
    tiltedRectangleRotation(n, m, matrix, r, c, m1, m2, m3, m4, dir);
